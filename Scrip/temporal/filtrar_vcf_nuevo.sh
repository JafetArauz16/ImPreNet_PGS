...
POS_FILE="/home/garauzaguir/TFM_Jafet_Arauz/Reference_Data/GTEx_Models/model_keys.tsv"   # CHROM POS REF ALT
OUTDIR="/home/garauzaguir/TFM_Jafet_Arauz/Results/PrediXcan_prep/VCF_filtrado_nuevo"
VCF_OUT="${OUTDIR}/nhs_subjects_hg38_filtrado_${MODEL_NAME}_POS_nuevo.vcf.gz"
THREADS=16
# =================================

mkdir -p "$OUTDIR"
TMP_DIR="$(mktemp -d)"
ADJ_KEYS="${TMP_DIR}/model_keys.adjusted.tsv"
BED_FILE="${TMP_DIR}/model_keys.bed"
