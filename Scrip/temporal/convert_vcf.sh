...
# ==== Rutas ====
WORKDIR="/home/garauzaguir/TFM_Jafet_Arauz/Results/Correcciones_Raw_data"
BFILE="${WORKDIR}/nhs_subjects_hg19_final"
CORR_FILE="/home/garauzaguir/TFM_Jafet_Arauz/Results/Bim_Check/Resultados_Raw_data/Force-Allele1-nhs_subjects-HRC.txt"

BASE="nhs_hg9_corrected"
VCF_TXT="${BASE}.vcf"
VCF_GZ="${BASE}.vcf.gz"
